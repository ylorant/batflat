...
class Pagination
{
    ...
    * @return string|false
    */
    public function nav(string $type = 'pagination', int $maxLinks = 10)
    {
        if ($this->totalPages() > 1) {
            ...
            if ($this->hasPreviousPage()) {
                if ($type == 'pagination') {
                    ...
                    $links .= '<li class="previous"><a href="' . sprintf($this->url, $this->previousPage()) . '">&larr;</a></li>';
                }
            } else {
                if ($type == 'pagination') {
            ...
            if ($this->hasNextPage()) {
                if ($type == 'pagination') {
                    ...
                    $links .= '<li class="next"><a href="' . sprintf($this->url, $this->nextPage()) . '">&rarr;</a></li>';
                }
            } else {
                if ($type == 'pagination') {
                    $links .= '<li class="disabled"><a href="#">+</a></li>';
